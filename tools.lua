...
-- Little Razor
minetest.register_tool("brewing:little_razor", {
	description = S("Little Razor"),
	inventory_image = "brewing_little_razor_inv.png",
	wield_image = "brewing_little_razor.png",
	tool_capabilities = {
